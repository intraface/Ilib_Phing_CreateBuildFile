...
class Ilib_Phing_BuildFile_CreateProperties
{
    ...
    public function readValuesFromBuildFile($file)
    {
        ...
        if (!empty($values['pear_channel_username'])) {
            $this->pear_channel_username = $values['pear_channel_username'];
        }
        if (!empty($values['pear_channel_password'])) {
            $this->pear_channel_password = $values['pear_channel_password'];
        }
        if (!empty($values['ftp_user'])) {
            $this->ftp_user = $values['ftp_user'];
        }
        if (!empty($values['ftp_password'])) {
            $this->ftp_password = $values['ftp_password'];
        }
    }
}
