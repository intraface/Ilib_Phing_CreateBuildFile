...
class Ilib_Phing_BuildFile_Create
{
     ...
     * Get file roles
     *
     * @param $role TODO What?
     *
     * @return array
     */
    protected function getFileRoles($role)
    {
     ...
     * @return string
     */
    protected function createTaskTest()
    {
     ...
     * @return string
     */
    protected function createTaskPhpDocumentor()
    {
     ...
     * @return string
     */
    protected function createTaskPhpcs()
    {
     ...
     * @return string
     */
    protected function createTaskDeploy()
    {
     ...
     * @return string
     */
    protected function createTaskMakePearPackage()
    {
     ...
     * @return string
     */
    protected function createTaskBuild()
    {
     ...
     * @return string
     */
    protected function createTaskPear()
    {
     ...
     * @return string
     */
    protected function createTaskExport()
    {
     ...
     * @return string
     */
    protected function createTaskPrepare()
    {
     ...
     * @return string
     */
    protected function createTaskDefinitions()
    {
     ...
     * @return string
     */
    protected function createProject($content)
    {
     ...
     * @return string
     */
    protected function createHeader($content)
    {
